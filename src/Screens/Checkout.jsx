                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-col justify-between h-[88%]">
                        ...
                        <div className="py-3 flex justify-between items-center">
                            <Link to={'/cart'} className='text-blue-500 underline'>Go back</Link>
                            <button className="p-3 text-white bg-red-600 text-3xl font-bold" id='checkoutPrice'>Pay $44.50</button>
                        </div>
                     </div>
                </div>
